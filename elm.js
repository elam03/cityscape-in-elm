...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var texturedBuilding = $Graphics$Collage.toForm(A3($Graphics$Element.image,
   35,
   35,
   "minimal_industry.png"));
   var darkGrey = A4($Color.rgba,50,50,50,0.6);
   var clearGrey = A4($Color.rgba,111,111,111,0.6);
   var building = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.move,
                                                  {ctor: "_Tuple2",_0: 50,_1: 10},
                                                  A2($Graphics$Collage.filled,
                                                  clearGrey,
                                                  A2($Graphics$Collage.rect,50,100)))
                                                  ...
                                                  A2($Graphics$Collage.filled,
                                                  clearGrey,
                                                  A2($Graphics$Collage.ngon,3,50))))]));
   var buildingDebug = function (_p0) {
      var _p1 = _p0;
      var _p2 = _p1._0;
      var topHeight = 5;
      var topWidth = 50;
      ...
      return $Graphics$Collage.group(_U.list([A2($Graphics$Collage.move,
                                             {ctor: "_Tuple2",_0: _p2 + w,_1: 0},
                                             A2($Graphics$Collage.filled,
                                             clearGrey,
                                             A2($Graphics$Collage.rect,w,h)))
                                             ,A2($Graphics$Collage.move,
                                             {ctor: "_Tuple2",_0: _p2 + topWidth / 2,_1: h / 2},
                                             A2($Graphics$Collage.filled,
                                             darkGrey,
                                             $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: 0,_1: 0}
                                                                               ,{ctor: "_Tuple2",_0: topWidth,_1: 0}
                                                                               ,{ctor: "_Tuple2",_0: topWidth - topHeight,_1: h / 8}
                                                                               ,{ctor: "_Tuple2",_0: topHeight,_1: h / 8}]))))]));
   };
   var debugStuff = function (model) {
   ...
   var view = F2(function (_p3,model) {
      var _p4 = _p3;
      var _p6 = _p4._0;
      var _p5 = {ctor: "_Tuple2",_0: model.x,_1: model.y};
      var dx = _p5._0;
      var dy = _p5._1;
      ...
      _U.list([A2($Graphics$Collage.move,
              ...
              buildingDebug({ctor: "_Tuple2",_0: dx,_1: dy}))
              ,A2($Graphics$Collage.move,
              ...
              A2($Graphics$Collage.filled,
              $Color.red,
              A2($Graphics$Collage.ngon,3,25)))
              ,A2($Graphics$Collage.move,
              {ctor: "_Tuple2"
              ,_0: $Basics.toFloat(0 - _p6) / 3
              ,_1: $Basics.toFloat(_p6) / 3},
              debugStuff(model))]));
   });
   var input3 = function () {
   ...
   var timeUpdate = F2(function (dt,model) {
      return _U.update(model,{t: model.t + dt});
   });
   var mouseUpdate = F2(function (_p7,model) {
      var _p8 = _p7;
      return _U.update(model,
      {x: $Basics.toFloat(_p8._0),y: $Basics.toFloat(_p8._1)});
   });
   var keysUpdate = F2(function (keys,model) {
      return _U.update(model,
      {kx: model.kx + keys.x,ky: model.ky + keys.y});
   });
   var update3 = F2(function (_p9,model) {
      var _p10 = _p9;
      return A2(keysUpdate,
      _p10._1,
      A2(mouseUpdate,
      {ctor: "_Tuple2",_0: _p10._2._0,_1: _p10._2._1},
      A2(timeUpdate,_p10._0,model)));
   });
   var update2 = F2(function (_p11,model) {
      var _p12 = _p11;
      return A2(mouseUpdate,
      {ctor: "_Tuple2",_0: _p12._1._0,_1: _p12._1._1},
      A2(timeUpdate,_p12._0,model));
   });
   var update = F2(function (_p13,model) {
      var _p14 = _p13;
      return A2(timeUpdate,_p14._0,A2(keysUpdate,_p14._1,model));
   });
   var appModel = {x: 0,y: 0,kx: 0,ky: 0,t: 0};
   var main = A3($Signal.map2,
   view,
   $Window.dimensions,
   A3($Signal.foldp,update3,appModel,input3));
   var Keys = F2(function (a,b) {    return {x: a,y: b};});
   var Model = F5(function (a,b,c,d,e) {
      return {x: a,y: b,kx: c,ky: d,t: e};
   });
   return _elm.Main.values = {_op: _op
                             ...
                             ,texturedBuilding: texturedBuilding};
};
